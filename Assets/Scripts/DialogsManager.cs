	...
	void Update () {
		...
		if(askingCue){
			...
			// THEN THE PLAYER ANSWERS => Players Choices
				...
				//Fading bubbles in
				answer1.color = new Color(answer1.color.r, answer1.color.g, answer1.color.b, Mathf.Lerp(answer1.color.a, 1f, 0.1f));
				answer2.color = new Color(answer2.color.r, answer2.color.g, answer2.color.b, Mathf.Lerp(answer2.color.a, 1f, 0.1f));
				answer3.color = new Color(answer3.color.r, answer3.color.g, answer3.color.b, Mathf.Lerp(answer3.color.a, 1f, 0.1f));
			...
			// Last bit, reinitializing stuff, waiting for cue to end
				...
				//Fading bubbles away
				answer1.color = new Color(answer1.color.r, answer1.color.g, answer1.color.b, Mathf.Lerp(answer1.color.a, 0.0f, 0.2f));
				answer2.color = new Color(answer2.color.r, answer2.color.g, answer2.color.b, Mathf.Lerp(answer2.color.a, 0.0f, 0.2f));
				answer3.color = new Color(answer3.color.r, answer3.color.g, answer3.color.b, Mathf.Lerp(answer3.color.a, 0.0f, 0.2f));
